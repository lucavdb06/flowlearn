...
```mermaid
pie showData
    title Budget Communication 60 k€ - 4 axes
    "Inbound (Contenu + Organique)" : 22
    "Outbound (Influenceurs + RP)" : 20
    "Relations Investisseurs" : 10
    "Outils & Contingence" : 8
```
...
```mermaid
pie showData
    title Répartition par axe marketing (sur les 60 k€ com)
    "Inbound (organique)" : 22
    "Outbound (acquisition)" : 20
    "Relations Investisseurs" : 10
    "Outils & contingence" : 8
```
...
```mermaid
gantt
    title FlowLearn - Calendrier marketing 24 mois
    dateFormat YYYY-MM
    axisFormat %b %y

    section Phase 1
    Setup Discord + LinkedIn   :a1, 2026-04, 2m
    Stratégie TikTok organique :a2, 2026-05, 2m
    Bêta + presse              :a3, 2026-06, 1m
    Lancement public           :milestone, a4, 2026-07, 0d
    Optimisation rétention     :a5, 2026-08, 2m

    section Phase 2
    Tests pubs payantes        :b1, 2026-10, 2m
    Push B2B (cas d'étude)     :b2, 2026-12, 2m
    Pitch investisseurs        :b3, 2027-02, 2m

    section Phase 3
    Localisation contenu intl  :c1, 2027-04, 3m
    Lancement EU + Brésil      :c2, 2027-07, 5m

    section Phase 4
    Roadshow Series A          :d1, 2027-12, 3m
    Closing                    :milestone, d2, 2028-03, 0d
```
...
```mermaid
xychart-beta
    title "ROI marketing par phase (multiplicateur)"
...
```mermaid
flowchart TD
    A["🌐 300 M impressions (TikTok/Meta)"] --> B["👆 7.5 M clics<br/>CTR 2.5%"]
    B --> C["📲 2.5 M installations<br/>33% install"]
    C --> D["✨ 750k onboarding<br/>30% activation"]
    D --> E["🎯 300k actifs J7<br/>40% rétention D7"]
    E --> F["💎 90k conversion premium<br/>30% conversion"]
    F --> G["💰 900 k€/mois revenu<br/>10 €/user"]
```
